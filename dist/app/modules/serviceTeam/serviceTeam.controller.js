...
exports.ServiceTeamController = exports.getAllFromDB = exports.insertIntoDB = void 0;
...
const serviceTeam_constant_1 = require("./serviceTeam.constant");
const serviceTeam_service_1 = require("./serviceTeam.service");
exports.insertIntoDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = req.body;
    const result = yield serviceTeam_service_1.ServiceTeamServices.insertIntoDB(data);
...
exports.getAllFromDB = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(req.query, serviceTeam_constant_1.serviceTeamFilterableFields);
    const paginationOptions = (0, pick_1.default)(req.query, paginationFields_1.paginationFields);
    const result = yield serviceTeam_service_1.ServiceTeamServices.getAllFromDB(filters, paginationOptions);
...
const getDataById = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield serviceTeam_service_1.ServiceTeamServices.getDataById(req.params.id);
    if (!result) {
        return next(new ApiError_1.default(`No Service Team found with this id`, http_status_1.default.NOT_FOUND));
    }
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updateDataById = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield serviceTeam_service_1.ServiceTeamServices.updateDataById(req.params.id, payload);
    if (!result) {
        return next(new ApiError_1.default(`No Service Team found with this id`, http_status_1.default.NOT_FOUND));
    }
    (0, sendResponse_1.default)(res, {
...
const deleteDataById = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield serviceTeam_service_1.ServiceTeamServices.deleteDataById(req.params.id);
    if (!result) {
        return next(new ApiError_1.default(`No Service Team found with this id`, http_status_1.default.NOT_FOUND));
    }
    (0, sendResponse_1.default)(res, {
