...
exports.FeaturedInServices = void 0;
...
const insertIntoDB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.featuedIn.create({
        data,
    });
    return result;
});
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const andConditions = (0, findFilterConditions_1.findFilterConditionsWithoutRelation)(searchTerm, filterData, featuedIn_constant_1.featuredInSearchableFields);
    ...
    const result = yield prisma_1.default.featuedIn.findMany({
        where: whereConditons,
        skip,
        take: limit,
        orderBy: orderCondition,
    });
    const total = yield prisma_1.default.featuedIn.count();
    return {
        meta: {
            total,
            page,
...
const getDataById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.featuedIn.findUnique({
        where: {
            id,
        },
    });
...
const updateDataById = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.featuedIn.update({
        where: {
            id,
        },
        data: payload,
...
const deleteDataById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.featuedIn.delete({
        where: {
            id,
        },
    });
