...
exports.UpcomingServiceController = exports.getAllFromDB = exports.insertIntoDB = void 0;
...
const upcomingService_service_1 = require("./upcomingService.service");
exports.insertIntoDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = req.body;
    const result = yield upcomingService_service_1.UpcomingServiceServices.insertIntoDB(data);
...
exports.getAllFromDB = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(req.query, upcomingService_constant_1.upcomingServiceFilterableFields);
    const paginationOptions = (0, pick_1.default)(req.query, paginationFields_1.paginationFields);
    const result = yield upcomingService_service_1.UpcomingServiceServices.getAllFromDB(filters, paginationOptions);
...
const getDataById = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield upcomingService_service_1.UpcomingServiceServices.getDataById(req.params.id);
    if (!result) {
...
const updateDataById = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield upcomingService_service_1.UpcomingServiceServices.updateDataById(req.params.id, payload);
    if (!result) {
        return next(new ApiError_1.default(`No Service found with this id`, http_status_1.default.NOT_FOUND));
    }
    (0, sendResponse_1.default)(res, {
...
const deleteDataById = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield upcomingService_service_1.UpcomingServiceServices.deleteDataById(req.params.id);
    if (!result) {
        return next(new ApiError_1.default(`No Service found with this id`, http_status_1.default.NOT_FOUND));
    }
    (0, sendResponse_1.default)(res, {
...
exports.UpcomingServiceController = {
