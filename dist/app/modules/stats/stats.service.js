...
const insertIntoDB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.stats.create({
        data,
        include: {
...
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const andConditions = (0, findFilterConditions_1.findFilterConditions)(searchTerm, filterData, stats_constant_1.statSearchableFields, stats_constant_1.sstatRelationalFields, stats_constant_1.statRelationalFieldsMapper);
    ...
    const result = yield prisma_1.default.stats.findMany({
        include: {
            bestSellingService: true,
        },
    ...
    const total = yield prisma_1.default.stats.count();
    return {
        meta: {
            total,
            page,
...
const getDataById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.stats.findUnique({
        where: {
            id,
        },
        include: {
...
const updateDataById = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.stats.update({
        where: {
            id,
        },
        data: payload,
...
const deleteDataById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.stats.delete({
        where: {
            id,
        },
        include: {
