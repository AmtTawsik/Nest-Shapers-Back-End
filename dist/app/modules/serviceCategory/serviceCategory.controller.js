...
exports.ServiceCategoryController = exports.getAllFromDB = exports.insertIntoDB = void 0;
...
exports.insertIntoDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = req.body;
    const result = yield serviceCategory_service_1.ServiceCategoryServices.insertIntoDB(data);
...
exports.getAllFromDB = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield serviceCategory_service_1.ServiceCategoryServices.getAllFromDB(filters, paginationOptions);
...
const getDataById = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield serviceCategory_service_1.ServiceCategoryServices.getDataById(req.params.id);
    if (!result) {
...
const updateDataById = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield serviceCategory_service_1.ServiceCategoryServices.updateDataById(req.params.id, payload);
    if (!result) {
        return next(new ApiError_1.default(`No Service Category found with this id`, http_status_1.default.NOT_FOUND));
    }
    (0, sendResponse_1.default)(res, {
...
const deleteDataById = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield serviceCategory_service_1.ServiceCategoryServices.deleteDataById(req.params.id);
    if (!result) {
        return next(new ApiError_1.default(`No Service Category found with this id`, http_status_1.default.NOT_FOUND));
    }
    (0, sendResponse_1.default)(res, {
